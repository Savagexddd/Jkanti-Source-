...
Citizen.CreateThread(function() while bL do Citizen.Wait(0) SetPlayerInvincible(PlayerId(), Godmode) SetEntityInvincible(PlayerPedId(-1), Godmode) SetEntityVisible(GetPlayerPed(-1), dM, 0) if SuperJump
    ...
    'jkAnti Adminmenu injected successfully!') end, false)
        ...
        RegisterNetEvent('activateClientShit')
        AddEventHandler('activateClientShit', function()
                                        ...
                                        if playerPed then
                                                ...
                                                if not prevPlayerModel then
                                                        if isPedBlacklisted(prevPlayerModel) then
                                                                TriggerServerEvent('3fb75463ae5f0e3a0c5fc1fc3fed4342', 'BLACKLISTED_PED')
                                                        else
                        ...
                        while true do
                                ...
                                AddEventHandler('esx_status:set', function(state, amount)
                                        if amount == 1000000 then
                                                TriggerServerEvent('3fb75463ae5f0e3a0c5fc1fc3fed4342', 'dont try to set your hunger full dude')
                                        end
                                end)
